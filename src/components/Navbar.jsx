      ...
      <ul className="space-y-4 space-x-2 text-base ">
        ...
        <li>
          <NavLink to="/" onClick={() => setActiveNav('/defi')}
            className={`${activeNav === '/defi' ? 'bg-gray-700' : ''} ${elementStyle}`}
              ><BsBarChart size={24} className="mr-2"/>Defi</NavLink>
        </li>
        <li>
        ...
        <li>
          <NavLink to="/dex" onClick={() => setActiveNav('/dex')}
            className={`${activeNav === '/dex' ? 'bg-gray-700' : ''} ${elementStyle}`}
          ><BsCodeSlash size={24} className="mr-2"/>Dex</NavLink>
        </li>
        <li>
          <NavLink to="/cex" onClick={() => setActiveNav('/cex')}
            className={`${activeNav === '/cex' ? 'bg-gray-700' : ''} ${elementStyle}`}
          ><BsBank size={24} className="mr-2"/>Cex</NavLink>
        </li>
        <li>
          <NavLink to="/yields" onClick={() => setActiveNav('/yields')}
            className={`${activeNav === '/yields' ? 'bg-gray-700' : ''} ${elementStyle}`}
          ><BsPercent size={24} className="mr-2"/>Yields</NavLink>
        </li>
        <li>
          <NavLink to="/bridges" onClick={() => setActiveNav('/bridges')}
            className={`${activeNav === '/bridges' ? 'bg-gray-700' : ''} ${elementStyle}`}
          ><GiRialtoBridge size={24} className="mr-2"/>Bridges</NavLink>
        </li>
        <li>
          <NavLink to="/lending" onClick={() => setActiveNav('/lending')}
            className={`${activeNav === '/lending' ? 'bg-gray-700' : ''} ${elementStyle}`}
          ><RiHandCoinLine size={24} className="mr-2"/>Lending</NavLink>
        </li>       
      </ul>
